...
function getTooltipPlacement(graph, x, y) {
  var canvas = graph.get('canvas');
  var width = canvas.get('width');
  var height = canvas.get('height');
  var pointerTop = y <= height / 4;
  var pointerBottom = y >= 3 * height / 4;
  var pointerLeft = x <= width / 4;
  var pointerRight = x >= 3 * width / 4;
...
var _default = getContainerStyles;
