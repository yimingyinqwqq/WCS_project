...
var _layout2 = require("./utils/layout");
...
var Graphin = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Graphin(props) {
    ...
    _this.initGraphInstance = function () {
      ...
      var themeResult = (0, _index.getDefaultStyleByTheme)(theme);
      ...
      if (_this.isTree) {
        ...
        if (!_this.useGraphinLayoutController) {
          ...
          _this.options.layout = (0, _layout2.processLayoutConfig)(layout, _this.graph) || _consts.DEFAULT_GRAPH_LAYOUT_OPTIONS;
        }
  ...
  _createClass(Graphin, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      var layout = (0, _cloneDeep.default)(LAYOUT);
      ...
      if (isDataChange) {
        ...
        if (this.isTree) {
          ...
          if (this.useGraphinLayoutController) {
            ...
            var layoutCfg = (0, _layout2.processLayoutConfig)(layout, this.graph); // 兼容布局参数
        ...
        this.initStatus();
        this.apis = (0, _apis.default)(this.graph);
      ...
      if (isLayoutChange) {
        ...
        if (this.useGraphinLayoutController) {
          ...
          var _layoutCfg = (0, _layout2.processLayoutConfig)(layout, this.graph); // 兼容布局参数
