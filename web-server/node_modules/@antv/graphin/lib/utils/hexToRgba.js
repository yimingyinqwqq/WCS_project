...
exports.hexToRgbaToHex = exports.default = void 0;
...
var hexToRgbaToHex = function hexToRgbaToHex(hex) {
  ...
  var G = g.toString(16);
  var B = b.toString(16);
  var A = Math.round(Number(a) * 255).toString(16);
...
exports.hexToRgbaToHex = hexToRgbaToHex;
