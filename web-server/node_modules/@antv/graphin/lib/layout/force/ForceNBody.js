...
exports.forceNBodyBruteForce = forceNBodyBruteForce;
...
function forceNBodyBruteForce(nodes, coulombDisScale, repulsion) {
...
function forceNBody(nodes, coulombDisScale, repulsion) {
  ...
  var tree = (0, _d3Quadtree.quadtree)(data, function (d) {
    return d.x;
  }, function (d) {
    return d.y;
