...
var _g2 = _interopRequireDefault(require("@antv/g6"));

var _util = require("@antv/util");

var _theme2 = require("../theme");

var _calcByteLength = _interopRequireDefault(require("../utils/calcByteLength"));
...
var processKeyshape = function processKeyshape(cfg, style) {
  ...
  if (type === 'loop' || source.id === target.id) {
    ...
    var R = nodeSize / 2;
    var dy = Math.sqrt(Math.max(Math.pow(R, 2) - Math.pow(dx, 2), 0));
    var RX = rx || R * 2 * 0.5;
    var RY = ry || R * 2 * 0.6;
...
var _default = function _default() {
  _g2.default.registerEdge('graphin-line', {
    draw: function draw(cfg, group) {
      ...
      if (hasLabel) {
        ...
        if (hasBackground) {
          var byteLength = (0, _calcByteLength.default)(value);
          var calcWidth = byteLength * fontSize * 0.6;
          ...
          var _h = Object.assign(Object.assign({}, defaultBackground), background),
              fill = _h.fill,
              width = _h.width,
              height = _h.height,
              stroke = _h.stroke,
              otherBackgroundAttrs = __rest(_h, ["fill", "width", "height", "stroke"]);

          var _y = -height / 2 + offsetY;

          if (isLoop) {
            // 自环情况下需要特殊处理位置
            _y = -(height / 2 + offsetY + fontSize + nodeSize * 1 + (((_e = keyShapeStyle === null || keyShapeStyle === void 0 ? void 0 : keyShapeStyle.loop) === null || _e === void 0 ? void 0 : _e.distance) || 0) * 2);
          }
        ...
        if (isLoop) {
          if (hasBackground) {
            y = -(offsetY + fontSize / 2 + nodeSize * 1 + (((_f = keyShapeStyle === null || keyShapeStyle === void 0 ? void 0 : keyShapeStyle.loop) === null || _f === void 0 ? void 0 : _f.distance) || 0) * 2);
          } else {
            y = -(offsetY + fontSize + nodeSize * 1 + (((_g = keyShapeStyle === null || keyShapeStyle === void 0 ? void 0 : keyShapeStyle.loop) === null || _g === void 0 ? void 0 : _g.distance) || 0) * 2);
          }
        }
