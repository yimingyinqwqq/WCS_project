...
var parseHalo = function parseHalo(style) {
  ...
  return {
    name: 'halo',
    visible: visible !== false,
    attrs: (0, _utils.removeDumpAttrs)(attrs)
  };
};
...
var parseLabel = function parseLabel(style) {
  ...
  var labelPos = (0, _utils.getLabelXYByPosition)(style);
  var attrs = Object.assign({
    x: labelPos.x,
    y: labelPos.y,
    fontSize: fontSize,
...
var parseIcon = function parseIcon(style) {
  ...
  var _convertSizeToWH = (0, _utils.convertSizeToWH)(size),
...
var drawBadge = function drawBadge(badge, group, r) {
  var type = badge.type,
      ...
      id = badge.id;
  var offset = (0, _utils.convertSizeToWH)(inputOffset);

  var _convertSizeToWH3 = (0, _utils.convertSizeToWH)(badgeSize),
      _convertSizeToWH4 = _slicedToArray(_convertSizeToWH3, 2),
      width = _convertSizeToWH4[0],
      height = _convertSizeToWH4[1];

  var _getBadgePosition = (0, _utils.getBadgePosition)(position, r),
...
var _default = function _default() {
  _g.default.registerNode('graphin-circle', {
    options: {
      style: {},
      status: {}
    },
    draw: function draw(cfg, group) {
      ...
      var style = (0, _util.deepMix)({}, this.options.style, cfg.style); // getStyles({}, this.options.style, cfg.style) as NodeStyle;
    ...
    update: function update(cfg, item) {
      ...
      try {
        var style = (0, _util.deepMix)({}, cfg._initialStyle, cfg.style); // getStyles(cfg._initialStyle, cfg.style) as NodeStyle;
        ...
        (0, _utils.setStatusStyle)(shapes, style, parseAttr);
