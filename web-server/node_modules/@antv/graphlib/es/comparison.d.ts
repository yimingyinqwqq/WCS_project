 ...
 */
export declare const containSameEdges: <NodeIDType = any>(aGraph: Graph<NodeIDType, Record<string, any>, Record<string, any>, string>, bGraph: Graph<NodeIDType, Record<string, any>, Record<string, any>, string>) => boolean;
/**
